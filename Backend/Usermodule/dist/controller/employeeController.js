...
// Create a new H1
var createH1 = /*#__PURE__*/function () {
  ...
  return function createH1(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Get all H1
var getH1 = /*#__PURE__*/function () {
  ...
  return function getH1(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

// Update an H1
var updateH1 = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          id = req.body.id;
          updateData = req.body; // Update the document with the given ObjectID
          _context3.next = 5;
          return H1.updateOne({
            _id: id
          }, {
        ...
        case 8:
          res.status(200).json({
            message: 'H1 updated successfully'
          });
          _context3.next = 14;
          break;
        case 11:
  ...
  return function updateH1(_x5, _x6) {
...
var createEmployee = /*#__PURE__*/function () {
  ...
  return function createEmployee(_x7, _x8) {
...
var getAllEmployees = /*#__PURE__*/function () {
  ...
  return function getAllEmployees(_x9, _x10) {
...
var getEmployeeById = /*#__PURE__*/function () {
  ...
  return function getEmployeeById(_x11, _x12) {
...
var updateEmployee = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _context7.next = 3;
          return Employee.findByIdAndUpdate(req.params.id, req.body, {
            "new": true,
            runValidators: true
          });
        case 3:
  ...
  return function updateEmployee(_x13, _x14) {
...
var deleteEmployee = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.prev = 0;
          _context8.next = 3;
          return Employee.findByIdAndDelete(req.params.id);
        case 3:
  ...
  return function deleteEmployee(_x15, _x16) {
    return _ref8.apply(this, arguments);
  };
}();

// Get history of a specific employee
var getEmployeeHistory = /*#__PURE__*/function () {
  ...
  return function getEmployeeHistory(_x17, _x18) {
